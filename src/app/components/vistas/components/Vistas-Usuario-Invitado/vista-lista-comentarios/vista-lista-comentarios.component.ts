...
volverAtras(): void {
  ...
  window.history.back();
<<<<<<< HEAD:src/app/vistas/components/Vistas-Usuario-Invitado/vista-lista-comentarios/vista-lista-comentarios.component.ts
}


=======
>>>>>>> Miguel-Anguel-Diaz-Rivera:src/app/components/vistas/components/Vistas-Usuario-Invitado/vista-lista-comentarios/vista-lista-comentarios.component.ts
}
