...
<<<<<<< HEAD:src/app/vistas/components/Vistas-Usuario-Invitado/favoritos-usuarios/favoritos-usuarios.component.ts
  categoriaSeleccionada: number = 0; // 0 = Todas
=======
  listaCategorias: any[] = [];
>>>>>>> Miguel-Anguel-Diaz-Rivera:src/app/components/vistas/components/Vistas-Usuario-Invitado/favoritos-usuarios/favoritos-usuarios.component.ts
